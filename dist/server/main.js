...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.interceptors.request.use(function (objConfig) {
  if (typeof window === 'undefined') {
    return objConfig;
  }

  var strToken = window.localStorage.getItem('token');
...
var appService = {
  getPosts: function getPosts(numCategoryId) {
    return new Promise(function (resolve) {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/wp-json/wp/v2/posts?categories=' + numCategoryId + '&per_page=6').then(function (response) {
  ...
  login: function login(objCredentials) {
    return new Promise(function (resolve, reject) {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/services/auth.php', objCredentials).then(function (response) {
        resolve(response.data);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__appScript__ = __webpack_require__(7);


/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  __WEBPACK_IMPORTED_MODULE_0__appScript__["b" /* router */].push(context.url);
  return Promise.all(__WEBPACK_IMPORTED_MODULE_0__appScript__["b" /* router */].getMatchedComponents().map(function (component) {
    if (component.asyncData) {
      return component.asyncData(__WEBPACK_IMPORTED_MODULE_0__appScript__["c" /* store */], __WEBPACK_IMPORTED_MODULE_0__appScript__["b" /* router */].currentRoute);
    }
  })).then(function () {
    context.initialState = __WEBPACK_IMPORTED_MODULE_0__appScript__["c" /* store */].state;
    return __WEBPACK_IMPORTED_MODULE_0__appScript__["a" /* myApp */];
  });
});
...
var myApp = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a(_extends({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appScript_service_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__posts__ = __webpack_require__(10);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex___default.a.Store({
  ...
  state: state,
  getters: {
    blnIsAuthenticated: function blnIsAuthenticated(state) {
  ...
  actions: {
    ...
    loginAction: function loginAction(context, objCredentials) {
      return new Promise(function (resolve) {
        __WEBPACK_IMPORTED_MODULE_2__appScript_service_js__["a" /* default */].login(objCredentials).then(function (data) {
  ...
  mutations: {
    ...
    loginMutation: function loginMutation(state, token) {
      if (typeof window !== 'undefined') {
...
if (typeof window !== 'undefined') {
  document.addEventListener('DOMContentLoaded', function (event) {
    ...
    var numExpiration = window.localStorage.getItem('tokenExpiration');
    var numUnixTimestamp = new Date().getTime() / 1000;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__appScript_service_js__ = __webpack_require__(3);
...
var blnInBrowser = typeof window !== 'undefined';
var state = blnInBrowser && window.__INITIAL_STATE__ ? window.__INITIAL_STATE__.postsmodule : defaultState;
...
var actions = {
  updateCategoryAction: function updateCategoryAction(context, numCategoryId) {
    return __WEBPACK_IMPORTED_MODULE_0__appScript_service_js__["a" /* default */].getPosts(numCategoryId).then(function (arrData) {
      context.commit('updateCategoryMutation', { numCategoryId: numCategoryId, posts: arrData });
    });
  }
};

var mutations = {
  updateCategoryMutation: function updateCategoryMutation(state, objCategory) {
...
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "6c63829a"
...
module.exports.__inject__ = function (context) {
  add("2b86212a", content, true, context)
};
...
/* Template binding with child components: */



/* harmony default export */ __webpack_exports__["a"] = ({
  components: {
    'app-header-component': __WEBPACK_IMPORTED_MODULE_0__AppHeader_vue__["a" /* default */],
    'app-footer-component': __WEBPACK_IMPORTED_MODULE_1__AppFooter_vue__["a" /* default */]
  }
});
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "21f77ece"
var Component = normalizeComponent(
...
/* harmony default export */ __webpack_exports__["a"] = ({
  computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapGetters"])(['blnIsAuthenticated']))
});
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [(_vm.blnIsAuthenticated) ? _c('span', [_vm._v("Logout")]) : _c('span', [_vm._v("Login")])])], 2)])
}
var staticRenderFns = []
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "00c51adc"
var Component = normalizeComponent(
  __vue_script__,
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('app-header-component'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main-section section\">", "</section>", [_vm._ssrNode("<div class=\"container content\">", "</div>", [_c('router-view')], 1)]), _vm._ssrNode(" "), _c('app-footer-component')], 2)
}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "6d11b724"
var Component = normalizeComponent(
...
var fetchInitalData = function fetchInitalData(store, route) {
  var numCategoryId = 2;
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: {
    'post-component': __WEBPACK_IMPORTED_MODULE_0__Post_vue__["a" /* default */]
  },
...
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "682be9e0"
var Component = normalizeComponent(
...
var add = __webpack_require__(5)
module.exports.__inject__ = function (context) {
  add("7171e8e8", content, true, context)
};
...
// module
exports.push([module.i, ".card[data-v-e458c95e]{padding-bottom:2rem;height:100%}footer[data-v-e458c95e]{position:absolute;left:0;bottom:0;width:100%}", ""]);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "card"
  }, [_vm._ssrNode("<div class=\"card-content\" data-v-e458c95e>", "</div>", [_vm._t("title"), _vm._ssrNode(" "), _vm._t("content")], 2), _vm._ssrNode(" <footer class=\"card-footer\" data-v-e458c95e><a" + (_vm._ssrAttr("href", _vm.postLink)) + " target=\"_blank\" class=\"card-footer-item\" data-v-e458c95e>Read More</a></footer>")], 2)
}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _vm._ssrNode("<div class=\"column is-one-third\">", "</div>", [_c('post-component', {
      attrs: {
        "postLink": post.rest_api_enabler.Link
      }
    }, [_c('h3', {
      domProps: {
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "53ca9eae"
var Component = normalizeComponent(
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapActions"])({
    ...
    loginMethod: function loginMethod() {
      ...
      this.$store.dispatch('loginAction', { username: this.strUsername, password: this.strPassword }).then(function () {
        _this.strUsername = '';
        _this.strPassword = '';
      });
    }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "content"
  }, [_vm._ssrNode(((_vm.blnIsAuthenticated) ? ("<div>\n    Hello authenticated user!\n    <button class=\"button is-primary\">Logout</button></div>") : ("<div><h2>Login</h2> <div class=\"field is-horizontal\"><div class=\"field-label is-normal\"><label class=\"label\">Username</label></div> <div class=\"field-body\"><div class=\"field\"><div class=\"control\"><input type=\"text\" placeholder=\"Your username\"" + (_vm._ssrAttr("value", (_vm.strUsername))) + " class=\"input\"></div></div></div></div> <div class=\"field is-horizontal\"><div class=\"field-label is-normal\"><label class=\"label\">Password</label></div> <div class=\"field-body\"><div class=\"field\"><div class=\"control\"><input type=\"password\" placeholder=\"Your password\"" + (_vm._ssrAttr("value", (_vm.strPassword))) + " class=\"input\"></div></div></div></div> <div class=\"field is-horizontal\"><div class=\"field-label\"></div> <div class=\"field-body\"><div class=\"field\"><div class=\"control\"><button class=\"button is-primary\">\n          Login\n          </button></div></div></div></div></div>")))])
}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
var __vue_scopeId__ = null
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = "7a75e142"
var Component = normalizeComponent(
  __vue_script__,
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_vm._ssrNode("Oops, 404 page not found!")])
}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
